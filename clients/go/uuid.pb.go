...
type UUIDv4 struct {
	...
	// Canonical hyphenated UUID v4 string (36 characters)
...
const file_uuid_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"uuid.proto\x12\x11macro_traffic_sim\"\x1e\n" +
	"\x06UUIDv4\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05valueB@Z>github.com/LdDl/macro_traffic_sim_grpc/clients/go;macrotrafficb\x06proto3"
...
var file_uuid_proto_goTypes = []any{
	(*UUIDv4)(nil), // 0: macro_traffic_sim.UUIDv4
}
